        ...
        <section className="panel p-6">
          ...
          {canManage ? (
            <div className="mb-3 grid gap-2 md:grid-cols-[1fr_240px_auto]">
              <Input className="md:col-span-3" placeholder="일정 제목" value={title} onChange={(event) => setTitle(event.target.value)} />
              <Input type="datetime-local" value={dateTime} onChange={(event) => setDateTime(event.target.value)} />
              <Input placeholder="설명 (선택)" value={description} onChange={(event) => setDescription(event.target.value)} />
        ...
        <section className="panel p-6">
          ...
          {canManage && editRecruitmentId ? (
            <div className="mb-4 space-y-2 rounded-xl border border-slate-200 bg-slate-50 p-3">
              ...
              <Input placeholder="제목" value={recruitmentTitle} onChange={(event) => setRecruitmentTitle(event.target.value)} />
              <Input placeholder="내용" value={recruitmentContent} onChange={(event) => setRecruitmentContent(event.target.value)} />
        ...
        <section className="panel p-6">
          ...
          {canManage ? (
            <div className="mb-4 space-y-2">
              <Input placeholder="공지 제목" value={noticeTitle} onChange={(event) => setNoticeTitle(event.target.value)} />
              <Input placeholder="공지 내용" value={noticeContent} onChange={(event) => setNoticeContent(event.target.value)} />
